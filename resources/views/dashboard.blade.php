...
<main style="height: 100vh">
    ...
    <div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-dark" style="width: 225px;">
        ...
        <ul class="nav nav-pills flex-column mb-auto">
            <li class="nav-item">
                <a href="#" class="nav-link text-white active" id="mock-server-tab" data-bs-toggle="tab" data-bs-target="#mock-server" role="tab" aria-controls="mock-server" aria-selected="false">
    ...
    <div class="tab-content" style="width: 100%; height: 100%; overflow: auto;">
        <!-- Mock Server -->
        <div id="mock-server" class="tab-pane fade show active" role="tabpanel" aria-labelledby="mock-server-tab">
